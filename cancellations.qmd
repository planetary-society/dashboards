...
format:
  dashboard:
    ...
    description-meta: "Dashboard tracking NASA grants and contracts terminated by the Trump Admininistration."
      ...
      - text: |
          ...
          <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Select the anchor tag within the navbar brand container
                const logoLink = document.querySelector('.navbar-brand-container a');
                if (logoLink) {
                    // Set the href attribute to the desired URL
                    logoLink.href = 'https://planetary.org';
                    // Optional: Add rel="noopener noreferrer" for security when using target="_blank"
