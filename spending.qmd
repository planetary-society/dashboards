...
COLOR_LOW_SPENDING = '#8C8C8C' # Light Blue for low spending
COLOR_HIGH_SPENDING = '#037CC2' # Dark Blue for high spending
...
if all(col in df_cleaned.columns for col in ['GEOID', 'district', 'avg_obligations']):
    for index, row in df_cleaned.iterrows():
        ...
        avg_amount_str = f"${row['avg_obligations']:,.0f}"
...
# --- Create and Add Colormap Legend ---
    legend_colormap = LinearColormap(
        ...
        index=[0, max_avg_obligation],
        vmin=0,
        vmax=max_avg_obligation
    )
...
if congressional_geojson_data:
    ...
    _ = folium.GeoJson(
        ...
        style_function=choropleth_style_callback,
